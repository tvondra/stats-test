...
copy results_master from program 'gunzip -c /home/user/stats-xeon/master-1M.csv.gz';
copy results_patched from program 'gunzip -c /home/user/stats-xeon/patched-1M.csv.gz';
copy results_patched_fixed from program 'gunzip -c /home/user/stats-xeon/patched-fixed-1M.csv.gz';
